...
class CommentQuestionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comment_question" do
    assert_difference('CommentQuestion.count') do
      post comment_questions_url, params: { comment_question: { comment_id: @comment_question.comment_id, question_id: @comment_question.question_id } }
    end
  ...
  test "should update comment_question" do
    patch comment_question_url(@comment_question), params: { comment_question: { comment_id: @comment_question.comment_id, question_id: @comment_question.question_id } }
